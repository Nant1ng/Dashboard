...
function Create() {
  ...
  return (
    <div className="create">
      <h2>Add a new Airbnb</h2>
      <form onSubmit={(e) => addNewAirbnb(e)}>
        <label>Airbnb Title:</label>
        <input
          type="text"
          required
          value={title}
        ...
        />
        <label>Airbnb Description:</label>
        <textarea
          required
          value={description}
        ...
        <select value={feature} onChange={(e) => setFeature(e.target.value)}>
          ...
          <option value="Local Charges Payable at Airbnb">
            Local Charges Payable at Airbnb
          </option>
          ...
          <option value="Private parking at the Airbnb">
            Private parking at the Airbnb
          </option>
